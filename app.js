// ============================================================
//  app.js — StockFlow (Sistema de Pedidos de Material)
//  Viu Internet · Desenvolvido por Felipe dos Santos Garcia
//
//  Índice rápido (Ctrl+F pelo marcador):
//    [ESTADO]        variáveis globais do app
//    [SKELETON]      placeholders de carregamento
//    [AUTH]          login/logout Google, guarda de acesso
//    [TECNICOS]      cadastro/seleção de técnicos
//    [CONFIG]        aba Configurações (tema, som)
//    [NOVO PEDIDO]   catálogo de itens, popover de qtd, envio
//    [MEUS PEDIDOS]  lista + edição do próprio pedido (técnico)
//    [PEDIDOS]       lista geral, filtros, estatísticas, paginação
//    [MODAL]         modal de detalhes do pedido
//    [KANBAN]        board de estoque + drag&drop
//    [FIREBASE]      listeners em tempo real (onSnapshot) + init()
//    [DASHBOARD]     gráficos e KPIs
//    [NOTIFICACOES]  toasts in-app, push do navegador
// ============================================================
import {
